// BT FileResolver.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CBTFileResolverApp, CWinApp)
    ON_COMMAND(ID_APP_ABOUT, &CBTFileResolverApp::OnAppAbout)
END_MESSAGE_MAP()


// CBTFileResolverApp 构造
...
// 唯一的一个 CBTFileResolverApp 对象

CBTFileResolverApp theApp;


// CBTFileResolverApp 初始化
